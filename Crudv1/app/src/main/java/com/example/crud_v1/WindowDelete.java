...
public class WindowDelete extends AppCompatActivity {
    EditText search, document, name, lastName, phone, addres, email;
    public Boolean typeUrl = true;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_window_delete);
    ...
    public void process(View view){
        ...
        String url;
        if (this.typeUrl){
            url = "http://192.168.0.23/APIenPHP/Consulta.php";
        }else{
            url = "http://192.168.0.23/APIenPHP/Delete.php";
        }
